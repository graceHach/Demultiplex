...
ax[0,0].set_xlabel("Read position")
...
ax[1,0].plot(range(1,102,1),f2_means,color='darkmagenta',label='Means')
ax[1,0].fill_between(range(1,102,1), f2_mins, f2_maxs,alpha=.2,label="Full range",color='steelblue')
ax[1,0].set_title(args.f2_title)
...
ax[0,1].plot(range(1,102,1),f3_means,color='seagreen',label='Means')
ax[0,1].fill_between(range(1,102,1), f3_mins, f3_maxs,alpha=.2,label="Full range",color='springgreen')
ax[0,1].set_title(args.f3_title)
ax[0,1].legend(loc='lower right')
ax[0,1].set_xlabel("Read position")
ax[0,1].set_ylabel("Phred quality score")

print("starting r4")
f4_means, f4_mins, f4_maxs = get_stats(args.f4_in, args.f4_length)
print("calcs done")

ax[1,1].plot(range(1,102,1),f4_means,color='maroon',label='Means')
ax[1,1].fill_between(range(1,102,1), f4_mins, f4_maxs,alpha=.2,label="Full range",color='firebrick')
ax[1,1].set_title(args.f4_title)
ax[1,1].legend(loc='lower right')
ax[1,1].set_xlabel("Read position")
ax[1,1].set_ylabel("Phred quality score")
